...
const fr = {
  ...
  "nav.comptes": "Utilisateurs",
  "nav.comptes.aide": "Comptes et accès",
  ...
  "nav.roles": "Rôles",
  "nav.roles.aide": "Permissions par profil",
  "nav.audit": "Audit et journal",
  "nav.audit.aide": "Qui a fait quoi",
  ...
  "mode.titre": "Mode de connexion",
  "mode.demo": "Démonstration",
  "mode.demoAide": "Comptes fournis, connexion immédiate",
  "mode.reel": "Réel",
  "mode.reelAide": "Vos identifiants, votre agence",
...
const en: Record<Cle, string> = {
  ...
  "mode.titre": "Sign-in mode",
  "mode.demo": "Demonstration",
  "mode.demoAide": "Accounts provided, straight in",
  "mode.reel": "Real",
  "mode.reelAide": "Your credentials, your branch",
